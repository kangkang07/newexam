         ...
         angular.forEach(response.data,function(q,i)
                {
                    ...
                    //乱序排列选项
                    var ro=new Array(4);
                    ro[0]={op:$sce.trustAsHtml(q.o1.toString()),ind:1};
                    ro[1]={op:$sce.trustAsHtml(q.o2.toString()),ind:2};
                    ro[2]={op:$sce.trustAsHtml(q.o3.toString()),ind:3};
                    ro[3]={op:$sce.trustAsHtml(q.o4.toString()),ind:4};
